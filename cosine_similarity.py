    ...
    def __init__(self, test_path):
        ...
        for line_data in tqdm(read_data):
            self.data.append({
                ...
                # 'NeedReasoning': line_data['NeedReasoning']
            })
...
if __name__ == '__main__':
    ...
    # parser.add_argument("--train_set", type=str, default="../data/KCT_train_public.txt",
    #                     help="Input dataset in json format.")
    # parser.add_argument("--test_set", type=str, default="../data/KCT_train_public.txt",
    #                     help="Input dataset in json format")
    parser.add_argument("--train_set", type=str, default="./data/self_made/train2/",
                        help="Input dataset in json format.")
    parser.add_argument("--test_set", type=str, default="./data/self_made/test2/",
                        help="Input dataset in json format")
    parser.add_argument("--output_dir", type=str, default="./data/self_made/suffix2/test/", help="Output dir.")
    ...
    set_list = os.listdir('./data/self_made/train2/')

    results = []
    all_len = 0
    for set in set_list:
        # if set == 'useless.txt' or set == 'CommonSense.txt':
        # if set == 'useless.txt':
        #     continue
        ...
        for idx, sentence in zip(indices, test_set):
            results.append({
                'qid': sentence['qid'],
                # 'query': train_set[idx] + ' [SEP] ' + sentence['query'],
                ...
                # 'NeedReasoning': sentence['NeedReasoning']
            })
        all_len += len(results)
