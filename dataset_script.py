...
def keyword_select(data, args):
    ...
    if args.data_type == 'train':
        if data['domain'] == 'Common Sense':
            return 'CommonSense'
        # if data['NeedReasoning']:
        #     return 'others_NeedReasoning'
...
def init_argparse():
    ...
    parser.add_argument('--read_path', type=str, default='./data/KCT_train_public.txt')
    parser.add_argument('--write_path', type=str, default='./data/self_made/train2/')
    ...
    args.key_words = {
        ...
        'name_TV': ['series'],
        # 'name_MadeBy': ["a song by", 'an album by'],

        'person_parents': ['father is', 'the father of', 'father.', 'mother is', 'the mother of'],
        # 'person_mother': ['mother is', 'the mother of'],
        # 'person_star': ['fiml starring', 'film starring', 'fiml stars', 'cast member'],
        'person_film': ['directed', 'fiml starring', 'film starring', 'fiml stars', 'cast member', 'written', 'screenwriters', 'wrote', 'screenwriter'],
        # 'person_writer': ['written', 'screenwriters', 'wrote', 'screenwriter'],
        'person_supervisor': ['supervised', 'supervisor', 'advisor'],

        # 'name_MusicGenre': ['music genre'],

        # 'others': ['others'],
        # 'others_NeedReasoning': ['NeedReasoning'],
        # 'others_CommonSense': ['common sense']
